	...
	return (
		<View style={{ flex: 1, backgroundColor: '#FFF7DB'}}>
			...
			<View style={styles.textInputView}>
				<TextInput style={styles.textInput} value={name} placeholder='    nombre' onChangeText={text => setName(text)} />
				<TextInput style={styles.textInput} value={age} placeholder='    edad' onChangeText={text => setAge(text)} />
			</View>

			<View style={styles.selectType}>
				<TouchableOpacity style={styles.gender} onPress={() => setGender('macho')}>
					<Text style={styles.text}>Macho</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.gender} onPress={() => setGender('hembra')}>
			...
			<View style={{flexDirection: 'row'}}>
				<View>
					<TouchableOpacity style={styles.buttom} onPress={() => addPet(name, age, gender, type, () => navigation.navigate('Pets'))}>
